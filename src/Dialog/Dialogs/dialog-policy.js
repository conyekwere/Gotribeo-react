...
export class DialogPolicy extends React.Component {
  ...
  render() {
    const policy = <Fragment>

      <p> Gotribeo built the Gotribeo app as a Freemium app. This SERVICE is provided by Gotribeo at no cost and
      ...
      <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
          accessible at Gotribeo unless otherwise defined in this Privacy Policy.
                    </p>
      <p>
        <strong>Information Collection and Use</strong>
      </p>
      <p>For a better experience, while using our Service, we may require you to provide us with certain personally
          identifiable information, including but not limited to Phone number, Facebook Friends, Email Address
      ...
      <p>These Services do not address anyone under the age of 13. We do not knowingly collect personally identifiable
          information from children under 13. In the case we discover that a child under 13 has provided us
    ...
    return (
      <Fragment>
        <DialogWrapper show={this.props.show} onClose={this.props.onClose} dialogType='alert' title='Privacy Policy' content={policy} />
      </Fragment>
    );
  }
}